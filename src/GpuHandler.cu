...
int GpuHandler::allocateDeviceMemory() {
...
int GpuHandler::sendDataToDevice(Structure * atomsStructure) {
...
int GpuHandler::getDataFromDevice() {
...
int GpuHandler::clearDeviceMemory() {
